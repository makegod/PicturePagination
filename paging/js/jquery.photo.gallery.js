...
(function ($) {
    ...
    $.fn.extend({
        ...
        photoGallery: function (options) {
            ...
            $fullscreen.on("click", function () {
                ...
                这个问题是存在跨域，地址栏不要出现file:///    要用ip或者localhost运行
                */
                var parentD = window.parent.document,//根据你实际嵌套的页面宽度，获取最外层的 document
    ...
    $.extend({
        ...
        openPhotoGallery: function (obj) {
            ...
            var $imgcon = $(obj).closest(".imgcon"),
                activeIndex = 0,
                imgs = [];
            $imgcon.find(".imgcon-pic").each(function (i, elem) {
                var url = this.src,
                    img = $(this)[0],
